...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/editar-paciente-registrado.css">
         <!-- NOTIFICACIONES OVERHANG.JS  1 -->
        <link rel="stylesheet" type="text/css" href="js/overhang/dist/overhang.min.css" />
        <link rel="stylesheet" href="js/jquery-ui/jquery-ui.min.css">
        <script type="text/javascript" src="js/editar-paciente-registrado.js"></script>
                ...
                <div class="col-lg-10 col-der" >
                    ...
                    <div class="row" id="grupo-titulo-pagina">
                        ...
                        <div class="col-md-6" id="titulo">
                            <h3 id="titulo-paciente">Editar paciente · Paciente <?php echo($_GET["id_user"]); ?></h3>
                        </div>
                        <!-- Breadcrumb -->
                        <div class="col-md-6">
                            ...
                            <div id="apartado-medicamentos">
                             ...
                             <div id="apartado-habitos">
                                ...
                                <form id="form-6" class="margen-form">
                                    ...
                                    <div class="columna-btn">
                                        <button class="btn estilo-boton-submit" type="submit" id="btn-submit-6" value='<?php echo($_SESSION["id_especialista"])?>'>Modificar</button>
                        ...
                        <!-- =============================== HISTORIAL TRATAMIENTO LINFEDEMA  ===========================================  -->
                            ...
                            <div id="apartado-hist-trat-linf">
                                ...
                                <form id="form-7" class="margen-form">
                                    ...
                                    <div class="columna-btn">
                                        <button class="btn estilo-boton-submit" type="submit" id="btn-submit-7" value='<?php echo($_SESSION["id_especialista"])?>'>Modificar</button>
                                    </div>
                                    <div class="form-group margen-oblig">
                                        <h5 class="rojo letra">* Campos obligatorios</h5>
                                        <h5 class="naranja letra">* Campos obligatorios en ciertas ocasiones</h5>
